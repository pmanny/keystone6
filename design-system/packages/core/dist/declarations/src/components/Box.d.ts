...
export declare const useBoxStyles: ({ background, foreground, height, margin, marginTop, marginRight, marginBottom, marginLeft, marginY, marginX, padding, paddingTop, paddingRight, paddingBottom, paddingLeft, paddingY, paddingX, rounding, roundingBottom, roundingLeft, roundingRight, roundingTop, textAlign, width, }: BoxProps) => any;
...
} & Omit<import("react").PropsWithoutRef<import("react").ComponentProps<Comp>>, "as" | keyof ColorProps | keyof RadiiProps | keyof MarginProps | keyof PaddingProps | keyof BaseBoxProps> & ColorProps & RadiiProps & MarginProps & PaddingProps & BaseBoxProps) => import("react").ReactElement;
export {};
