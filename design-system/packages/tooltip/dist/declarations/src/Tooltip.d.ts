/** @jsxRuntime classic */
/** @jsx jsx */
import { type CSSProperties, type ReactElement, type Ref, type ReactNode } from 'react';
...
export declare const Tooltip: ({ children, content, hideOnClick, placement, weight, }: Props) => JSX.Element;
type ElementProps = {
    /** The content of the tooltip. */
    children: ReactNode;
