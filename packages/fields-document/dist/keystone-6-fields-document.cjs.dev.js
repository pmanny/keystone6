...
var utils = require('./utils-efe9b207.cjs.dev.js');
var editorShared = require('./editor-shared-67872be6.cjs.dev.js');
var zod = require('zod');
var isValidURL = require('./isValidURL-23f0583b.cjs.dev.js');
var weakMemoize = require('@emotion/weak-memoize');
require('slate-history');
require('./layouts-shared-f3c33d4d.cjs.dev.js');
...
const zLink = zod.z.object({
  ...
  href: zod.z.string().refine(isValidURL.isValidURL)
}).strict();
...
const zElements = zod.z.object({
  type: zod.z.union([zod.z.literal('blockquote'), zod.z.literal('layout-area'), zod.z.literal('code'), zod.z.literal('divider'), zod.z.literal('list-item'), zod.z.literal('list-item-content'), zod.z.literal('ordered-list'), zod.z.literal('unordered-list')])
}).strict();
...
const zComponentProp = zod.z.object({
  type: zod.z.union([zod.z.literal('component-block-prop'), zod.z.literal('component-inline-prop')]),
  propPath: zod.z.array(zod.z.union([zod.z.string(), zod.z.number()])).optional()
}).strict();
const zBlock = zod.z.union([zComponentBlock.extend({
...
const zInline = zod.z.union([zText, zLink.extend({
  children: zod.z.lazy(() => zChildren)
}), zRelationship.extend({
  children: zod.z.lazy(() => zChildren)
})]);
const zChildren = zod.z.array(zod.z.union([zBlock, zInline]));
const zEditorCodec = zod.z.array(zBlock);
