import { type KeystoneContextFromListTypeInfo, type MaybePromise } from "../index.js";
...
export type ListHooks<ListTypeInfo extends BaseListTypeInfo> = {
     ...
     */
    validate?: ValidateHook<ListTypeInfo, 'create' | 'update' | 'delete'> | {
...
export type FieldHooks<ListTypeInfo extends BaseListTypeInfo, FieldKey extends ListTypeInfo['fields'] = ListTypeInfo['fields']> = {
     ...
     * Used to **validate** if a create, update or delete operation is OK
     */
    validate?: ValidateFieldHook<ListTypeInfo, 'create' | 'update' | 'delete', FieldKey> | {
...
export type ResolvedFieldHooks<ListTypeInfo extends BaseListTypeInfo, FieldKey extends ListTypeInfo['fields'] = ListTypeInfo['fields']> = {
    resolveInput: {
...
type ResolveInputFieldHook<ListTypeInfo extends BaseListTypeInfo, Operation extends 'create' | 'update', FieldKey extends ListTypeInfo['fields']> = (args: {
    create: {
        operation: 'create';
        item: undefined;
        /**
...
}[Operation] & CommonArgs<ListTypeInfo> & {
    fieldKey: FieldKey;
}) => MaybePromise<ListTypeInfo['prisma']['create' | 'update'][FieldKey] | undefined>;
export type ValidateHook<ListTypeInfo extends BaseListTypeInfo, Operation extends 'create' | 'update' | 'delete'> = (args: {
    create: {
        operation: 'create';
        item: undefined;
        /**
...
}[Operation] & CommonArgs<ListTypeInfo>) => MaybePromise<void>;
export type ValidateFieldHook<ListTypeInfo extends BaseListTypeInfo, Operation extends 'create' | 'update' | 'delete', FieldKey extends ListTypeInfo['fields']> = (args: {
    create: {
        operation: 'create';
        item: undefined;
        /**
...
type BeforeOperationListHook<ListTypeInfo extends BaseListTypeInfo, Operation extends 'create' | 'update' | 'delete'> = (args: {
    create: {
        operation: 'create';
        item: undefined;
        /**
...
type BeforeOperationFieldHook<ListTypeInfo extends BaseListTypeInfo, Operation extends 'create' | 'update' | 'delete', FieldKey extends ListTypeInfo['fields']> = (args: {
    create: {
        operation: 'create';
        item: undefined;
        /**
...
type AfterOperationListHook<ListTypeInfo extends BaseListTypeInfo, Operation extends 'create' | 'update' | 'delete'> = (args: {
    create: {
        operation: 'create';
...
type AfterOperationFieldHook<ListTypeInfo extends BaseListTypeInfo, Operation extends 'create' | 'update' | 'delete', FieldKey extends ListTypeInfo['fields']> = (args: {
    create: {
        operation: 'create';
        originalItem: undefined;
        item: ListTypeInfo['item'];
