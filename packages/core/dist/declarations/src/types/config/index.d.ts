...
import type { BaseKeystoneTypeInfo, KeystoneContext, DatabaseProvider } from "../index.js";
import type { SessionStrategy } from "../session.js";
import type { MaybePromise } from "../utils.js";
import { type IdFieldConfig, type ListConfig, type MaybeItemFunction, type MaybeSessionFunction } from "./lists.js";
import type { BaseFields } from "./fields.js";
import type { ListAccessControl, FieldAccessControl } from "./access-control.js";
import type { ListHooks, FieldHooks } from "./hooks.js";
type FileOrImage = {
    type: 'file';
...
export type KeystoneConfig<TypeInfo extends BaseKeystoneTypeInfo = BaseKeystoneTypeInfo> = {
    ...
    server?: {
        ...
        extendExpressApp?: (app: express.Express, context: KeystoneContext<TypeInfo>) => MaybePromise<void>;
...
export type { FieldCreateItemAccessArgs, FieldReadItemAccessArgs, FieldUpdateItemAccessArgs, IndividualFieldAccessControl, CreateListItemAccessControl, UpdateListItemAccessControl, DeleteListItemAccessControl, ListOperationAccessControl, ListFilterAccessControl, } from "./access-control.js";
export type { CommonFieldConfig } from "./fields.js";
export type { CacheHintArgs, IdFieldConfig } from "./lists.js";
