...
import { XCircleIcon, MenuIcon } from '@keystone-ui/icons';
...
import { S as SignoutButton } from './SignoutButton-ca58d8c9.esm.js';
...
const PageContainer = ({
  ...
  }, isSidebarOpen ? jsx(XCircleIcon, null) : jsx(MenuIcon, null))), jsx("header", {
    css: {
      alignItems: 'center',
      backgroundColor: colors.background,
      borderBottom: `1px solid ${colors.border}`,
