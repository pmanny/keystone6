...
import { h as humanize } from './next-fields-2535337e.esm.js';
...
const filterAccessError = ({
  operation,
  fieldKeys
}) => new GraphQLError(`You do not have access to perform '${operation}' operations on the fields ${JSON.stringify(fieldKeys)}.`, {
  extensions: {
...
function createAdminMeta(config, initialisedLists) {
  ...
  for (const [listKey, list] of Object.entries(initialisedLists)) {
    ...
    for (const [fieldKey, field] of Object.entries(list.fields)) {
      ...
      const fieldMeta = {
        key: fieldKey,
        label: (_field$ui$label = field.ui.label) !== null && _field$ui$label !== void 0 ? _field$ui$label : humanize(fieldKey),
...
export { accessReturnError as a, accessDeniedError as b, relationshipError as c, createAdminMeta as d, extensionError as e, filterAccessError as f, getAdminMetaForRelationshipField as g, limitsExceededError as l, resolverError as r, userInputError as u, validationFailureError as v };
