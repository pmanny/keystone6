...
import { g as getRootGraphQLFieldsFromFieldController } from './getRootGraphQLFieldsFromFieldController-3d1a0f41.esm.js';
...
function useChangedFieldsAndDataForUpdate(fields, itemGetter, value) {
  ...
  return useMemo(() => {
    ...
    Object.keys(serializedFieldValues).forEach(fieldKey => {
      const isEqual = isDeepEqual(serializedFieldValues[fieldKey], serializedValuesFromItem[fieldKey]);
      if (!isEqual) {
