...
import { u as usePreventNavigation } from './usePreventNavigation-11e5691f.esm.js';
      ...
      try {
        outputData = await createItem({
          ...
          update(cache, {
            ...
            var _data$item;
            if (typeof (data === null || data === void 0 || (_data$item = data.item) === null || _data$item === void 0 ? void 0 : _data$item.id) === 'string') {
              cache.evict({
                id: 'ROOT_QUERY',
